...
public class SizePanelAudio : MonoBehaviour, IPointerDownHandler, IDragHandler
{
    [Header("UI體積最小值")]
    ...
    void Start()
    {
        ...
        if (PlayerPrefs.HasKey("SizePanelAudioX"))
        {
            UIsize.x = PlayerPrefs.GetFloat("SizePanelAudioX");
            UIsize.y = PlayerPrefs.GetFloat("SizePanelAudioY");
            panelRectTransform.sizeDelta = UIsize;
        }
        if (PlayerPrefs.HasKey("MovePanelAudioX"))
        {
            UIposition.x = PlayerPrefs.GetFloat("MovePanelAudioX");
            UIposition.y = PlayerPrefs.GetFloat("MovePanelAudioY");
            panelRectTransform.position = UIposition;
            UIposition.x = PlayerPrefs.GetFloat("MovePanelAudioAX");
            UIposition.y = PlayerPrefs.GetFloat("MovePanelAudioAY");
    ...
    public void OnDrag(PointerEventData data)
    {
        if (UIresize)
        {
            ...
            PlayerPrefs.SetFloat("SizePanelAudioX", panelRectTransform.sizeDelta.x);
            PlayerPrefs.SetFloat("SizePanelAudioY", panelRectTransform.sizeDelta.y);
        }
        if (UImove)
        {
                ...
                normalizedMousePosition.y < panelRectTransform.anchorMax.y)
            {
                ...
                PlayerPrefs.SetFloat("MovePanelAudioX", UIposition.x);
                PlayerPrefs.SetFloat("MovePanelAudioY", UIposition.y);
                UIposition = panelRectTransform.anchoredPosition;
                PlayerPrefs.SetFloat("MovePanelAudioAX", UIposition.x);
                PlayerPrefs.SetFloat("MovePanelAudioAY", UIposition.y);
            }
        }
    }
